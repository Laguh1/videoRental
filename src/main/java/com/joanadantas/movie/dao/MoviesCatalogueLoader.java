...
public class MoviesCatalogueLoader {
    ...
    public static List<Movie> getAllMovies(){
        if (allMovies != null){
            ...
            Movie movie1 = new Movie("Matrix 11", LocalDate.of(2018,6,13));
            Movie movie2 = new Movie("Spider Man", LocalDate.of(2017,6,13));
            Movie movie3 = new Movie("Spider Man 2", LocalDate.of(2016,6,13));
            Movie movie4 = new Movie("Out of Africa", LocalDate.of(2011,6,13));
